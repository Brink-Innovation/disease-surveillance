...
const facilityFields = [
  {appliesToType: ['area_health_facility'], label: 'Facility Name', value: titleCaseLetters(thisContact.manual_name || thisContact.meta.name),width: 6},
  {appliesToType: ['area_health_facility'], label: 'Belongs To',  value: 'MOH Kenya', width: 6},
];
const diseaseSurveillanceFields = [
  {appliesToType: ['area_health_facility_nurse'], label: 'Name', value: thisContact.name || thisContact.meta.name, width: 4 },
  {appliesToType: ['area_health_facility_nurse'], label: 'Phone', value: thisContact.phone||'Not Provided', width: 4},
  {appliesToType: ['area_health_facility_nurse'], label: 'Belongs To', appliesIf: () => thisContact.parent && thisLineage[0], value: thisLineage, filter: 'lineage', width: 8 },
];
const communityHealthUnitFields = [
  {appliesToType: ['community_health_area'], label: 'Community Health Unit', value: thisContact.name || thisContact.meta.name, width: 4 },
  {appliesToType: ['community_health_area'], label: 'County', value: titleCaseLetters(thisContact.selected_county || thisContact.parent.selected_county), width: 4},
  {appliesToType: ['community_health_area'], label: 'Sub-County', value: titleCaseLetters(thisContact.selected_sub_county || thisContact.parent.selected_sub_county), width: 4},
  {appliesToType: ['community_health_area'], label: 'Ward', value: titleCaseLetters(thisContact.selected_ward || thisContact.parent.selected_ward), width: 4},
  {appliesToType: ['community_health_area'], label: 'Belongs To', appliesIf: () => thisContact.parent && thisLineage[0], value: thisLineage, filter: 'lineage', width: 8 },
];
const chpFields = [
  {appliesToType: ['community_health_volunteer'], label: 'Name', value: thisContact.name || thisContact.meta.name, width: 4 },
  {appliesToType: ['community_health_volunteer'], label: 'Phone', value: thisContact.phone||'Not Provided', width: 4},
  {appliesToType: ['community_health_volunteer'], label: 'Belongs To', appliesIf: () => thisContact.parent && thisLineage[0], value: thisLineage, filter: 'lineage', width: 8 },
];
const supervisorRegionFields = [
  {appliesToType: ['area_supervisor_region'], label: 'Name', value: thisContact.name || thisContact.meta.name, width: 4 },
  {appliesToType: ['area_supervisor_region'], label: 'Additional notes', value: thisContact.notes||'Not Available', width: 4},
  {appliesToType: ['area_supervisor_region'], label: 'Belongs To', appliesIf: () => thisContact.parent && thisLineage[0], value: thisLineage, filter: 'lineage', width: 8 },
];
const chaFields = [
  {appliesToType: ['area_community_health_supervisor'], label: 'Name', value: thisContact.name || thisContact.meta.name, width: 4 },
  {appliesToType: ['area_community_health_supervisor'], label: 'Phone', value: thisContact.phone||'Not Provided', width: 4},
  {appliesToType: ['area_community_health_supervisor'], label: 'Belongs To', appliesIf: () => thisContact.parent && thisLineage[0], value: thisLineage, filter: 'lineage', width: 8 },
];
